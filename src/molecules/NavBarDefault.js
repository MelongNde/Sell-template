        ...
        <div className="container-fluid">  
          ...
          <div id="navbarCollapse" className="collapse navbar-collapse">
            ...
            <div className="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
              ...
              <div className="nav-item dropdown"><Link to="/card" className="navbar-icon-link d-lg-none"> 
                  <svg className="svg-icon">
                  ...
                  </svg><span className="text-sm ml-2 ml-lg-0 text-uppercase text-sm font-weight-bold d-none d-sm-inline d-lg-none">View cart</span></Link>
