            ...
            <section>
                <div class="container">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-5 d-flex justify-content-between flex-column flex-lg-row"><a href="cart.html" class="btn btn-link text-muted"> <i class="fa fa-angle-left mr-2"></i>Back </a><Link to="/checkout/delivery-method" class="btn btn-dark">Choose delivery method<i class="fa fa-angle-right ml-2"></i></Link></div>
                        </form>
                    </div>
                    <div class="col-lg-4">
